...
def test_search_employer_paginates_and_filters_locations(monkeypatch) -> None:
    ...
    pages = {
        0: {
            "total": 21,
            "jobPostings": [
                {"title": "IT Technician", "locationsText": "Exampletown, UT", "externalPath": "/job/1"},
...
def test_workday_title_include_filter_keeps_target_roles(monkeypatch) -> None:
    ...
    jobs = [
        {"title": "Patient Service Representative", "location": "Exampletown", "external_path": "/patient"},
        {"title": "Police Officer", "location": "Exampletown", "external_path": "/police"},
    ]
    captured = {}
