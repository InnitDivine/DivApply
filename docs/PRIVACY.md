...
`.gitignore` blocks local/private/generated files such as `.divapply/`, `.applypilot/`, `.env`, `profile.json`, `resume.txt`, `divapply.db`, generated resumes, cover letters, logs, browser state, and screenshots.
