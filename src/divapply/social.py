...
class _BrowserCookie(TypedDict, total=False):
    name: str
    value: str
    url: str | None
    domain: str | None
...
def _extract_cookies(domains: list[str]) -> list[_BrowserCookie]:
    ...
    try:
        ...
        samesite_map: dict[int, Literal["None", "Lax", "Strict"]] = {0: "None", 1: "Lax", 2: "Strict"}

        cookies: list[_BrowserCookie] = []
        now_s = time.time()
